> Note (2026-09-03, claude-opus-5): Throwaway branch proving the required status checks block a merge. Layer 2 satisfied on purpose so the run reaches aahp check and fails on the governance gate itself rather than on content drift.
